...
output="rtmp://localhost:13933/test"
...
-thread_queue_size 512 -f s16le -ar 48000 -ac 2 -i "$audio_pipe" \
-vf "vflip" \
-r 30 -f flv -c:v libx264 -pix_fmt yuv420p -b:v 400k -c:a aac -ar 48000 -b:a 128k \
-listen 1 "$output"
